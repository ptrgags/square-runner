...
class NormalGameController extends GameCtrl
{
	...
	public var const:Const;				//For graphics
	...
	public function new(ctrl:Controller,level:Int):Void
	{
		...
		this.player = new Player(176,416,const.SPR_PLAYER.copyOf());
		...
		this.text.setDimensions(388,132,218,313);
