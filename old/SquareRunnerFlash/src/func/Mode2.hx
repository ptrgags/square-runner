...
class Mode2 
{
	...
	public static function init(ctrl:Controller)
	{
		...
		vars[2].addPic(new SprBlock(), 			2, 248,240);
		vars[2].addPic(new SprMovingBlock(),	2, 280,240);
		vars[2].addPic(new SprBreakBlock(), 	2, 312,240);
		vars[2].addPic(new SprLock(), 			2, 344,240);
		vars[2].addPic(new SprMoneyBlock(), 	2, 376,240);
		vars[2].addPic(new SprInvincible(), 	3, 248,240);
		vars[2].addPic(new SprSlow(), 			3, 280,240);
		vars[2].addPic(new SprAmmo(), 			3, 312,240);
		vars[2].addPic(new SprMoneybag(), 		3, 344,240);
		vars[2].addPic(new SprKey(), 			3, 376,240);
		vars[2].addPic(new SprFinish(), 		4, 248,240);
		vars[2].addPic(new SprReload(), 		4, 280,240);
		vars[2].addPic(new SprGoldTile(), 		4, 312,240);
		vars[2].addPic(new SprMinusCash(), 		4, 344,240);
		vars[2].addPic(new SprFlipTile(), 		4, 376,240);
		vars[2].initPage();
